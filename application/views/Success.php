...
<head>
    ...
    <style type="text/css">
        ...
        .msgbox{
            position: absolute;
            background-image: url(<?php echo STYLE_IMG_PATH?>/msg.gif);
...
<div class="msgbox">
    <div class="tit">
        ...
        <div class="r"><a href="<?php echo($jumpUrl); ?>"><img alt="关闭" border="0" src="<?php echo STYLE_IMG_PATH;?>/close_our.png" width="8" height="8" /></a></div>
    </div>
    <div class="con">
